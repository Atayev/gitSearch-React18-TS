...
function RepoCart({ repo }: { repo: IRepo }) {
    const { addToFavorites, removeFavorites } = useActions()
  ...
  return (
      <div className='border py-3 px-5 rounded-lg mb-2 hover:shadow-md hover:bg-gray-100 transition-all'>
